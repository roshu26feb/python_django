...
from delivery_db_api.resources.component_resource import Component, \
    ComponentVersion, ComponentsList, CompopnentVersionsList
from delivery_db_api.resources.component_type_resource import ComponentType
from delivery_db_api.resources.deployment_resource import Deployment, UpdateDeploymentStatus, UpdateInstanceForDeployment, HistoricComponentStatus, DeploymentViewDeploymentsList, DeploymentViewComponentsList
...
from delivery_db_api.resources.environment_resource import Environment, EnvironmentsList, EnvironmentsListBySystem, EnvironmentSystemelementsList, EnvironmentSystemelementComponentsList
...
from delivery_db_api.resources.environment_type_resource import EnvironmentType, EnvironmentTypeList
from delivery_db_api.resources.environment_use_resource import EnvironmentUse
from delivery_db_api.resources.host_region_resource import HostRegion, HostRegionsList
from delivery_db_api.resources.host_site_resource import HostSite, HostSitesList
from delivery_db_api.resources.host_subscription_resource import HostSubscription, HostSubscriptionList
from delivery_db_api.resources.host_type_resource import HostType
from delivery_db_api.resources.infrastructure_template_resource import InfrastructureTemplate, InfrastructureTemplatesList
from delivery_db_api.resources.infrastructure_type_resource import InfrastructureType
from delivery_db_api.resources.instance_resource import Instance, InstanceList, InstanceListWithoutDestroyed, InstanceViewInstanceList, InstanceViewInstanceDisks
from delivery_db_api.resources.method_creation_type_resource import MethodCreationType
from delivery_db_api.resources.network_set_resource import NetworkSet, NetworkSetsList
...
from delivery_db_api.resources.system_resource import System, EnvironmentAvailabilityViewSystemsList, SystemVersion, SystemViewSystemsList, SystemViewSystemVersionsList, SystemViewSystemElementsList, SystemViewComponentsList
...
from delivery_db_api.resources.environment_booking_resource import EnvironmentBooking, EnvironmentBookingClashes
...
def main(app_config):
    ...
    api.add_resource(
        EnvironmentsListBySystem,
        '/api/v2/eav_environments')

    api.add_resource(
        EnvironmentTypeList,
        '/api/v2/eav_environment_types')
    ...
    api.add_resource(
        ComponentsList,
        '/api/v2/cv_components')

    api.add_resource(
        CompopnentVersionsList,
        '/api/v2/cv_component_versions')

    api.add_resource(
        SystemViewSystemsList,
        '/api/v2/sv_systems')

    api.add_resource(
        EnvironmentAvailabilityViewSystemsList,
        '/api/v2/eav_systems')
    
    api.add_resource(
        SystemViewSystemVersionsList,
        '/api/v2/sv_system_versions')

    api.add_resource(
        SystemViewSystemElementsList,
        '/api/v2/sv_system_elements')

    api.add_resource(
        SystemViewComponentsList,
        '/api/v2/sv_components')
    
    api.add_resource(
        InstanceViewInstanceList,
        '/api/v2/iv_instances')

    api.add_resource(
        InstanceViewInstanceDisks,
        '/api/v2/iv_instance_disks')

    api.add_resource(
        DeploymentViewDeploymentsList,
        '/api/v2/dv_deployments')

    api.add_resource(
        DeploymentViewComponentsList,
        '/api/v2/dv_components')

    api.add_resource(
        InfrastructureTemplatesList,
        '/api/v2/itv_infrastructure_templates')

    api.add_resource(
        HostRegionsList,
        '/api/v2/hrv_host_regions')

    api.add_resource(
        HostSubscriptionList,
        '/api/v2/hsv_host_subscriptions')
    
    api.add_resource(
        HostSitesList,
        '/api/v2/hsv_host_sites')

    api.add_resource(
        NetworkSetsList,
        '/api/v2/nsv_network_sets')
    ...
    api.add_resource(
        EnvironmentBookingClashes,
        '/api/v2/environment_booking_clashes')
